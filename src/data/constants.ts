...
using use = useUsing("use")`,
  ...
  [SkillNames.LARAVEL]: {
    ...
    name: "laravel",
    label: "Laravel",
    shortDescription: "PHP framework that makes web dev feel like art, no cap! 🎨🔥",
    color: "#ff2d20",
  ...
  [SkillNames.YII]: {
    ...
    name: "yii",
    label: "Yii",
    shortDescription: "The high-performance PHP framework that's all about that speed! ⚡🚀",
    color: "#0078d0",
  ...
  [SkillNames.RAILS]: {
    ...
    name: "rails",
    label: "Ruby on Rails",
    shortDescription: "Convention over configuration? More like magic over manual work! ✨🛤️",
    color: "#cc0000",
  ...
  [SkillNames.MYSQL]: {
    ...
    name: "mysql",
    label: "MySQL",
    shortDescription: "The database that's been holding it down since '95, respect! 💾🗄️",
    color: "#4479a1",
  ...
  [SkillNames.DOTNET]: {
    ...
    name: "dotnet",
    label: ".NET",
    shortDescription: "Microsoft's powerhouse framework, building enterprise apps like a boss! 💪🔷",
    color: "#512bd4",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dot-net/dot-net-original-wordmark.svg",
  },
  [SkillNames.CSHARP]: {
    id: 31,
    name: "csharp",
    label: "C#",
    shortDescription: "C-sharp like a musical note, but for coding symphonies! 🎵💻",
    color: "#239120",
